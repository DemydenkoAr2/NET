...
{
    class Person(object id, string name)
	{
		public object Id { get; } = id;
		public string Name { get; } = name;
	}

    class Person<T>(T id, string name)
	{
    ...
    class Company<P>(P ceo)
	{
		public P CEO { get; set; } = ceo;
	}

    // Using Multiple Generic Parameters
    class Person<T, K>(T id, K password, string name)
	{
		public T Id { get; } = id;
		public K Password { get; set; } = password;
		public string Name { get; } = name;
	}
